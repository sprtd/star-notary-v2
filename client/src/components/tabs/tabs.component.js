...
const Tabs = () => {
  const { handleCreateStar, createStar,  handleLookUpStar, lookUpStar, handleExchangeStar, handleTransferStar } = useContext(TabsContext)
  ...
  return(
    <TabWrapper>
      ...
      <h3 onClick={() => handleExchangeStar(true)} >Exchange Stars</h3>
      <h3  onClick={() => handleTransferStar(true)}>Transfer Star</h3>
    </TabWrapper>
  )
